    ...
    return (
      <div id="loader">
        <div className="loader-logo">
          <img src="/logo-full-dark.svg" alt="evisas — get your visa on time" className="loader-logo-img" />
        </div>
    ...
    <>
      ...
      <nav id="nav" className={navSolid ? 'solid' : ''}>
        <div className="nav-logo" onClick={() => { closeCountry(); if (blogDetail !== null) { setBlogDetail(null); unlockScroll() } window.scrollTo({ top: 0, behavior: 'smooth' }) }} style={{ cursor: 'pointer' }}>
          <img src="/logo-horizontal-light.svg" alt="evisas" className="nav-logo-img" />
        </div>
          ...
          <div className="footer-grid">
            <div className="footer-brand">
              <div className="nav-logo">
                <img src="/logo-horizontal-dark.svg" alt="evisas" style={{ height: '40px', width: 'auto', display: 'block' }} />
              </div>
      ...
      <div id="guaranteePage" className={`slide-page${showGuarantee ? ' open' : ''}`}>
        <div className="cp-topbar">
          ...
          <div className="nav-logo"><img src="/logo-horizontal-light.svg" alt="evisas" className="nav-logo-img" /></div>
        </div>
